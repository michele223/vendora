...
<body class="font-sans"> <!-- Header -->
    ...
    <main class="text-center py-12">
        <h1 class="text-2xl font-bold text-yellow-500">Start Selling on Vendora: Join Our Marketplace Today!</h1>
        <p class="text-gray-700 mt-4">Vendora connects you to customers who value unique, quality products. Partner with
            us to showcase your goods on our platform and grow your business.</p>
        <div class="container mx-auto mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-blue-900 text-white p-8 rounded-lg">
                <h2 class="text-xl font-bold mb-4">Step 1</h2>
                <p>Reach out to our team via example@gmail.com or call us at 000-000-000. Let us know you're interested
                    in becoming a vendor.</p>
            </div>
            <div class="bg-blue-900 text-white p-8 rounded-lg">
                <h2 class="text-xl font-bold mb-4">Step 2</h2>
                <p>Once your application is approved, we'll arrange for you to sign a seller agreement in person.</p>
            </div>
            <div class="bg-blue-900 text-white p-8 rounded-lg">
                <h2 class="text-xl font-bold mb-4">Step 3</h2>
                <p>Upload your products, set your prices, and start reaching customers across Cameroon and beyond.</p>
            </div>
        </div>
    </main> <!-- Footer -->
