...
<body class="bg-white"> <!-- Header -->
    <header class="bg-yellow-500 text-center py-2 text-sm text-white"> Authentic · Sustainable · Proudly Cameroonian
        <!-- Header -->
                ...
                <div class="flex items-center relative">
                    ...
                    <div id="dropdown-menu"
                        ...
                        <ul class="py-2">
                            ...
                            <li><a href="kitchen.php" class="block px-4 py-2 hover:bg-gray-200">Kitchen and Dining</a>
                            </li>
