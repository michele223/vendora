...
<head>
  ...
  <title>How to Buy on Vendora</title>
...
<body class="flex flex-col min-h-screen">
  ...
  <main class="flex-grow p-8">
    <h1 class="text-2xl font-bold mb-4 text-center">How to Buy on Vendora</h1>
    <p class="text-gray-700 leading-relaxed">
      Buying on Vendora is easy! Follow these simple steps:
    </p>
    <ol class="mt-4 list-decimal ml-8 text-gray-600">
      <li>Browse our categories or use the search bar to find a product.</li>
      <li>Click on the product for more details and select your preferences (e.g., size, color).</li>
      <li>Add the product to your cart and proceed to checkout.</li>
      <li>Enter your delivery details and confirm your payment.</li>
      <li>Receive your product at your doorstep!</li>
    </ol>
  </main>
