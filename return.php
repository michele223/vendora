...
<body class="flex flex-col min-h-screen">
  ...
  <main class="flex-grow p-8">
    <h1 class="text-2xl font-bold mb-4 text-center">Possibility to Return a Product</h1>
    <p class="text-gray-700 leading-relaxed">
      At Vendora, we strive for customer satisfaction. You can return products under the following conditions:
    </p>
    <ul class="mt-4 list-disc ml-8 text-gray-600">
      ...
      <li>Proof of purchase is provided (e.g., order ID).</li>
    </ul>
    <p class="mt-4">
