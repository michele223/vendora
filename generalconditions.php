...
<head>
  ...
  <title>Possibility to Return a Product</title>
...
<body class="flex flex-col min-h-screen">
  ...
  <main class="flex-grow p-8">
    <main class="flex-grow p-8">
      <<h1 class="text-2xl font-bold mb-4 text-center">General Conditions</h1>
        <p class="text-gray-700 leading-relaxed">
          By using Vendora, you agree to the following terms and conditions:
        </p>
        <ul class="mt-4 list-disc ml-8 text-gray-600">
          <li>All users must provide accurate information when creating accounts.</li>
          <li>Sellers must ensure products listed meet quality and safety standards.</li>
          <li>Vendora reserves the right to suspend accounts for violations.</li>
          <li>Users are responsible for securing their accounts and maintaining confidentiality.</li>
        </ul>
