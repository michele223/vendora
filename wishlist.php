...
<body class="bg-white text-gray-800"> <!-- Header -->
    ...
    <main class="text-center py-8">
        <h1 class="text-3xl text-yellow-500 mb-8">Wishlist</h1>
        <div class="flex justify-center space-x-8"> <!-- Product Card -->
            <div class="bg-white shadow-md rounded-lg p-4"> <img src="https://placehold.co/300x300"
                    alt="Bomenbian cori baskets" class="rounded-t-lg mb-4">
                <h2 class="text-lg font-semibold">Bomenbian cori baskets <i class="fas fa-heart"></i></h2>
                <p class="text-blue-500">FCFA 25200 <span class="line-through text-gray-500">FCFA 34500</span></p>
                <button class="bg-blue-500 text-white px-4 py-2 rounded mt-4">ADD TO CART</button>
            </div> <!-- Product Card -->
            <div class="bg-white shadow-md rounded-lg p-4"> <img src="https://placehold.co/300x300"
                    alt="Bomenbian cori baskets" class="rounded-t-lg mb-4">
                <h2 class="text-lg font-semibold">Bomenbian cori baskets <i class="fas fa-heart"></i></h2>
