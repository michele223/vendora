...
<body class="bg-white text-gray-800"> <!-- Header -->
    ...
    <main class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-center text-yellow-500 mb-8">Place Order</h1>
        <div class="bg-gray-100 p-8 rounded-lg shadow-md max-w-2xl mx-auto">
            <h2 class="text-2xl font-bold text-center mb-6">Purchase</h2>
            <form class="space-y-4" method="POST" action="send_email.php">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input type="text" name="name" placeholder="Name" class="p-2 border rounded" required>
                    <input type="text" name="surname" placeholder="Surname" class="p-2 border rounded" required>
                    <input type="text" name="number" placeholder="Number" class="p-2 border rounded" required>
                    <input type="text" name="second_number" placeholder="Second Number (Optional)"
                        class="p-2 border rounded">
                    <input type="text" name="town" placeholder="Town" class="p-2 border rounded" required>
                    <input type="text" name="quarter" placeholder="Quarter" class="p-2 border rounded" required>
                </div>
                <input type="email" name="email" placeholder="Email" class="w-full p-2 border rounded" required>
                <button type="submit" class="w-full bg-blue-800 text-white py-2 rounded mt-4">Complete Purchase</button>
            </form>
        </div>

        <div class="flex justify-center space-x-4 mt-8">
            <a href="buyinshop.php" class="btn bg-yellow-500 text-white py-2 px-6 rounded">Buy in shop</a> <a
                href="buyinshop.php" class="btn bg-yellow-500 text-white py-2 px-6 rounded">Buy at Delivery</a><a
                href="paiement.php" class="btn bg-yellow-500 text-white py-2 px-6 rounded">Buy Now</a>
        </div>
    </main> <!-- Footer -->
