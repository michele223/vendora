...
<body class="bg-white">
   ...
   <main class="container mx-auto px-4 py-8">
      ...
      <div class="flex justify-center space-x-4 mb-8">
         <p>Filters</p>
         <button class="bg-blue-900 text-white px-4 py-2 rounded-full">Wood</button>
         <button class="bg-blue-900 text-white px-4 py-2 rounded-full">Wax</button>
         <button class="bg-blue-900 text-white px-4 py-2 rounded-full">Beads</button>
         <button class="bg-blue-900 text-white px-4 py-2 rounded-full">Price</button>
         <button class="bg-blue-900 text-white px-4 py-2 rounded-full">Popular</button>
      </div>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
         ...
         <div class="border rounded-lg p-4"> <img src="https://placehold.co/300x300" alt="Bomenbian cori baskets"
            ...
            <p class="text-blue-900 font-bold">FCFA 25200</p> <button
               class="bg-blue-900 text-white px-4 py-2 rounded-full mt-4">ADD TO CART</button>
            <button class="absolute top-4 right-4 text-gray-500"> <i class="fas fa-heart"></i> </button>
         </div> <!-- Repeat Product Card for each product -->
         <div class="border rounded-lg p-4"> <img src="https://placehold.co/300x300" alt="Bomenbian cori baskets"
               class="w-full h-48 object-cover mb-4">
            <h2 class="text-lg font-bold">Bomenbian cori baskets</h2>
            <p class="text-gray-500 line-through">FCFA 34500</p>
            <p class="text-blue-900 font-bold">FCFA 25200</p>
            <button class="bg-blue-900 text-white px-4 py-2 rounded-full mt-4">ADD TO CART</button>
            <button class="absolute top-4 right-4 text-gray-500"> <i class="fas fa-heart"></i> </button>
         </div>
         <div class="border rounded-lg p-4"> <img src="https://placehold.co/300x300" alt="Bomenbian cori baskets"
               class="w-full h-48 object-cover mb-4">
      ...
      <div class="text-center">
         <button class="bg-blue-900 text-white px-6 py-2 rounded-full" onclick="location.reload();">
            Next Page >
         </button>
      </div>
   </main>
